...
const navigation = [
  ...
  { name: "Billing Dashboard", href: "/billing-dashboard", icon: "💳" },
  { name: "Billing Plans", href: "/billing-plans", icon: "📋" },
  { name: "Revenue Reports", href: "/revenue-reports", icon: "📈" },
  { name: "Automated Bills", href: "/automated-bills", icon: "🧾" },
