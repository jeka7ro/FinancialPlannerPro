...
export default function Slots() {
    ...
    if (editingSlot) {
      updateMutation.mutate({
        ...
        data: {
          ...
          gamingPlaces: data.gamingPlaces ? Number(data.gamingPlaces) : undefined,
        }
      });
    }
  };
  ...
  const handleEdit = (slot: any) => {
    ...
    editForm.reset({
      ...
      maxBet: slot.maxBet || "",
      rtp: slot.rtp || "",
      year: slot.year !== undefined ? Number(slot.year) : undefined,
      gamingPlaces: slot.gamingPlaces !== undefined ? Number(slot.gamingPlaces) : undefined,
