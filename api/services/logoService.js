...
export class LogoService {
    constructor() {
        this.uploadsDir = path.join(process.cwd(), 'uploads', 'logos');
    ...
    async fetchLogoFromUrl(url, providerName) {
        try {
    ...
    saveUploadedLogo(file, providerName) {
        try {
    ...
    getSuggestedLogoUrl(providerName) {
